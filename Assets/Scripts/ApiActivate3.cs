...
public class ApiActivate3 : MonoBehaviour
{
    ...
    private string correctAnswer = "zamanýn fýsýltýlarý ona geçmiþteki önemli olaylarý keþfetmesine ve doðru kararlar vermesine yardýmcý oluyordu"; // Doðru cevap
    ...
    private IEnumerator GetRandomRiddle()
    {
        ...
        string riddlePrompt = "Sadece Þu soruyu sor: Zamanýn fýsýltýlarý Arin'e ne gibi faydalar saðlýyor? (Doðru Cevap Oda içerisindeki yazýtlarda olabilir) Cevap: zamanýn fýsýltýlarý ona geçmiþteki önemli olaylarý keþfetmesine ve doðru kararlar vermesine yardýmcý oluyordu CEVABI SÖYLEME.";
...
public class ApiActivate3 : MonoBehaviour
{
    ...
    private IEnumerator GetRandomRiddle()
    {
        ...
        string riddlePrompt = "Þu soruyu sor,  Zamanýn fýsýltýlarý Arin'e ne gibi faydalar saðlýyor? (Doðru Cevap Oda içerisindeki yazýtlarda olabilir) Cevap: zamanýn fýsýltýlarý ona geçmiþteki önemli olaylarý keþfetmesine ve doðru kararlar vermesine yardýmcý oluyordu CEVABI SÖYLEME.";
        string jsonPayload = "{\"contents\":[{\"parts\":[{\"text\":\"" + riddlePrompt + "\"}]}]}";
        string fullUrl = apiUrl + "?key=" + apiKey;
