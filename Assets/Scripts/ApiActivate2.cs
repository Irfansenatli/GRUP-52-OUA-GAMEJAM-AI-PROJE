...
public class ApiActivate2 : MonoBehaviour
{
    ...
    private string correctAnswer = "arin zamanýn efendileri tarafýndan eðitilmiþtir"; // Doðru cevap
    ...
    private IEnumerator GetRandomRiddle()
    {
        ...
        string riddlePrompt = "Sadece Þu soruyu sor:  Arin, gençliðinde kimler tarafýndan eðitilmiþtir? (Doðru Cevap Oda içerisindeki yazýtlarda olabilir) Cevap: Arin Zamanýn efendileri tarafýndan eðitilmiþtir CEVABI SÖYLEME.";
...
public class ApiActivate2 : MonoBehaviour
{
    ...
    private IEnumerator GetRandomRiddle()
    {
        ...
        string riddlePrompt = "Þu soruyu sor, Arin, gençliðinde kimler tarafýndan eðitilmiþtir? (Doðru Cevap Oda içerisindeki yazýtlarda olabilir) Cevap: Arin Zamanýn efendileri tarafýndan eðitilmiþtir CEVABI SÖYLEME.";
        string jsonPayload = "{\"contents\":[{\"parts\":[{\"text\":\"" + riddlePrompt + "\"}]}]}";
        string fullUrl = apiUrl + "?key=" + apiKey;
