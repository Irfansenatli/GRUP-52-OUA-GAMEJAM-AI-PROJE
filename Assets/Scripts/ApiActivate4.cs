...
public class ApiActivate4 : MonoBehaviour
{
    ...
    private string correctAnswer = "zamanýn koruyucusu olarak yeni maceralara ve zamanýn sýrlarýný keþfetmeye devam edecekti"; // Doðru cevap
    ...
    private IEnumerator GetRandomRiddle()
    {
        ...
        string riddlePrompt = "Sadece Þu soruyu sor: Arin, zamanýn koruyucusu olarak tapýnaktan ayrýldýktan sonra ne yapmaya devam etti? (Doðru Cevap Oda içerisindeki yazýtlarda olabilir) Cevap: Zamanýn koruyucusu olarak yeni maceralara ve zamanýn sýrlarýný keþfetmeye devam edecekti  CEVABI SÖYLEME.";
...
public class ApiActivate4 : MonoBehaviour
{
    ...
    private IEnumerator GetRandomRiddle()
    {
        ...
        string riddlePrompt = "Þu soruyu sor, Arin, zamanýn koruyucusu olarak tapýnaktan ayrýldýktan sonra ne yapmaya devam etti? (Doðru Cevap Oda içerisindeki yazýtlarda olabilir) Cevap: Zamanýn koruyucusu olarak yeni maceralara ve zamanýn sýrlarýný keþfetmeye devam edecekti  CEVABI SÖYLEME.";
        string jsonPayload = "{\"contents\":[{\"parts\":[{\"text\":\"" + riddlePrompt + "\"}]}]}";
        string fullUrl = apiUrl + "?key=" + apiKey;
